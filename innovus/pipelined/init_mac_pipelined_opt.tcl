...
set init_verilog [list $PROJ_ROOT/results/pipelined_sweep_600ps/mac_pipelined_mapped.v]
set init_top_cell mac_pipelined
...
optDesign -preCTS
timeDesign -preCTS -expandedViews -outDir $PROJ_ROOT/reports/innovus/prects_opt_timing

saveDesign $PROJ_ROOT/results/mac_pipelined_innovus_init.enc
